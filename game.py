  ...
  def run(self):
    ...
    while True:
      if self.game_active:
        ...
        self.screen.blit(self.map_surface,(803,125))
                    ...
                    if self.output_list == "invalid":
                      ...
                      for country in self.comparison.country_info_list:
                        if country.name == self.user_text:
                          ...
                          formatted_pop = "{:,}".format(country.pop)
                          formatted_area = "{:,}".format(country.area)
                          ...
                          self.box_row_list[self.guess_count][3].text = f"{formatted_area}   ---    {area_arrow}"
